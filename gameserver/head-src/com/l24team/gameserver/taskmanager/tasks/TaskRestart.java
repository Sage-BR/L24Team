...
public final class TaskRestart extends Task
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.tasks.Task#getName()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.tasks.Task#onTimeElapsed(com.l24team.gameserver.tasks.TaskManager.ExecutedTask)
	 */
	@Override
