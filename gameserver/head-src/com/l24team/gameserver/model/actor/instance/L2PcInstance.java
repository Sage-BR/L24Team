...
import static com.l24team.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
...
import com.l24team.gameserver.ai.L2CharacterAI;
import com.l24team.gameserver.ai.L2PlayerAI;
import com.l24team.gameserver.cache.HtmCache;
import com.l24team.gameserver.cache.WarehouseCacheManager;
import com.l24team.gameserver.communitybbs.BB.Forum;
import com.l24team.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l24team.gameserver.controllers.GameTimeController;
import com.l24team.gameserver.controllers.RecipeController;
import com.l24team.gameserver.datatables.AccessLevel;
import com.l24team.gameserver.datatables.GmListTable;
import com.l24team.gameserver.datatables.HeroSkillTable;
import com.l24team.gameserver.datatables.NobleSkillTable;
import com.l24team.gameserver.datatables.SkillTable;
import com.l24team.gameserver.datatables.csv.FishTable;
import com.l24team.gameserver.datatables.csv.HennaTable;
import com.l24team.gameserver.datatables.csv.MapRegionTable;
import com.l24team.gameserver.datatables.csv.RecipeTable;
import com.l24team.gameserver.datatables.sql.AccessLevels;
...
import com.l24team.gameserver.geo.GeoData;
import com.l24team.gameserver.handler.IItemHandler;
import com.l24team.gameserver.handler.ItemHandler;
...
import com.l24team.gameserver.managers.CoupleManager;
import com.l24team.gameserver.managers.CursedWeaponsManager;
import com.l24team.gameserver.managers.DimensionalRiftManager;
import com.l24team.gameserver.managers.DuelManager;
import com.l24team.gameserver.managers.FortSiegeManager;
import com.l24team.gameserver.managers.ItemsOnGroundManager;
import com.l24team.gameserver.managers.QuestManager;
import com.l24team.gameserver.managers.SiegeManager;
import com.l24team.gameserver.managers.TownManager;
import com.l24team.gameserver.model.BlockList;
import com.l24team.gameserver.model.FishData;
import com.l24team.gameserver.model.Inventory;
import com.l24team.gameserver.model.ItemContainer;
import com.l24team.gameserver.model.L2Attackable;
import com.l24team.gameserver.model.L2Character;
import com.l24team.gameserver.model.L2Clan;
import com.l24team.gameserver.model.L2ClanMember;
import com.l24team.gameserver.model.L2Effect;
import com.l24team.gameserver.model.L2Fishing;
import com.l24team.gameserver.model.L2Macro;
import com.l24team.gameserver.model.L2ManufactureList;
import com.l24team.gameserver.model.L2Object;
import com.l24team.gameserver.model.L2Party;
import com.l24team.gameserver.model.L2Radar;
import com.l24team.gameserver.model.L2RecipeList;
import com.l24team.gameserver.model.L2Request;
import com.l24team.gameserver.model.L2ShortCut;
import com.l24team.gameserver.model.L2Skill;
import com.l24team.gameserver.model.L2Skill.SkillTargetType;
import com.l24team.gameserver.model.L2Skill.SkillType;
import com.l24team.gameserver.model.L2SkillLearn;
...
import com.l24team.gameserver.model.MacroList;
...
import com.l24team.gameserver.model.PcFreight;
import com.l24team.gameserver.model.PcInventory;
import com.l24team.gameserver.model.PcWarehouse;
import com.l24team.gameserver.model.PetInventory;
import com.l24team.gameserver.model.PlayerStatus;
import com.l24team.gameserver.model.ShortCuts;
import com.l24team.gameserver.model.TradeList;
import com.l24team.gameserver.model.actor.appearance.PcAppearance;
import com.l24team.gameserver.model.actor.knownlist.PcKnownList;
import com.l24team.gameserver.model.actor.position.L2CharPosition;
import com.l24team.gameserver.model.actor.stat.PcStat;
import com.l24team.gameserver.model.actor.status.PcStatus;
import com.l24team.gameserver.model.base.ClassId;
import com.l24team.gameserver.model.base.ClassLevel;
import com.l24team.gameserver.model.base.PlayerClass;
import com.l24team.gameserver.model.base.Race;
import com.l24team.gameserver.model.base.SubClass;
import com.l24team.gameserver.model.entity.Announcements;
import com.l24team.gameserver.model.entity.Duel;
import com.l24team.gameserver.model.entity.L2Rebirth;
import com.l24team.gameserver.model.entity.event.CTF;
import com.l24team.gameserver.model.entity.event.DM;
import com.l24team.gameserver.model.entity.event.L2Event;
import com.l24team.gameserver.model.entity.event.TvT;
import com.l24team.gameserver.model.entity.event.VIP;
import com.l24team.gameserver.model.entity.olympiad.Olympiad;
import com.l24team.gameserver.model.entity.sevensigns.SevenSigns;
import com.l24team.gameserver.model.entity.sevensigns.SevenSignsFestival;
import com.l24team.gameserver.model.entity.siege.Castle;
import com.l24team.gameserver.model.entity.siege.FortSiege;
import com.l24team.gameserver.model.entity.siege.Siege;
import com.l24team.gameserver.model.entity.siege.clanhalls.DevastatedCastle;
import com.l24team.gameserver.model.extender.BaseExtender.EventType;
import com.l24team.gameserver.model.quest.Quest;
import com.l24team.gameserver.model.quest.QuestState;
...
import com.l24team.gameserver.network.serverpackets.ChangeWaitType;
import com.l24team.gameserver.network.serverpackets.CharInfo;
import com.l24team.gameserver.network.serverpackets.ConfirmDlg;
...
import com.l24team.gameserver.network.serverpackets.ExAutoSoulShot;
import com.l24team.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l24team.gameserver.network.serverpackets.ExFishingEnd;
import com.l24team.gameserver.network.serverpackets.ExFishingStart;
import com.l24team.gameserver.network.serverpackets.ExOlympiadMode;
import com.l24team.gameserver.network.serverpackets.ExOlympiadUserInfo;
import com.l24team.gameserver.network.serverpackets.ExPCCafePointInfo;
import com.l24team.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.l24team.gameserver.network.serverpackets.FriendList;
import com.l24team.gameserver.network.serverpackets.HennaInfo;
import com.l24team.gameserver.network.serverpackets.InventoryUpdate;
import com.l24team.gameserver.network.serverpackets.ItemList;
import com.l24team.gameserver.network.serverpackets.L2GameServerPacket;
import com.l24team.gameserver.network.serverpackets.LeaveWorld;
import com.l24team.gameserver.network.serverpackets.MagicSkillCanceld;
...
import com.l24team.gameserver.network.serverpackets.ObservationMode;
import com.l24team.gameserver.network.serverpackets.ObservationReturn;
import com.l24team.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.l24team.gameserver.network.serverpackets.PetInventoryUpdate;
import com.l24team.gameserver.network.serverpackets.PlaySound;
import com.l24team.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.l24team.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l24team.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l24team.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l24team.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l24team.gameserver.network.serverpackets.QuestList;
import com.l24team.gameserver.network.serverpackets.RecipeShopSellList;
import com.l24team.gameserver.network.serverpackets.RelationChanged;
import com.l24team.gameserver.network.serverpackets.Ride;
import com.l24team.gameserver.network.serverpackets.SendTradeDone;
import com.l24team.gameserver.network.serverpackets.SetupGauge;
import com.l24team.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.l24team.gameserver.network.serverpackets.ShortCutInit;
import com.l24team.gameserver.network.serverpackets.SkillCoolTime;
import com.l24team.gameserver.network.serverpackets.SkillList;
import com.l24team.gameserver.network.serverpackets.Snoop;
import com.l24team.gameserver.network.serverpackets.SocialAction;
import com.l24team.gameserver.network.serverpackets.StatusUpdate;
import com.l24team.gameserver.network.serverpackets.StopMove;
import com.l24team.gameserver.network.serverpackets.SystemMessage;
import com.l24team.gameserver.network.serverpackets.TargetSelected;
import com.l24team.gameserver.network.serverpackets.TitleUpdate;
import com.l24team.gameserver.network.serverpackets.TradePressOtherOk;
import com.l24team.gameserver.network.serverpackets.TradePressOwnOk;
import com.l24team.gameserver.network.serverpackets.TradeStart;
import com.l24team.gameserver.network.serverpackets.TutorialShowHtml;
...
import com.l24team.gameserver.skills.BaseStats;
import com.l24team.gameserver.skills.Formulas;
import com.l24team.gameserver.skills.Stats;
import com.l24team.gameserver.skills.effects.EffectCharge;
import com.l24team.gameserver.skills.l2skills.L2SkillSummon;
import com.l24team.gameserver.templates.L2Armor;
import com.l24team.gameserver.templates.L2ArmorType;
...
import com.l24team.gameserver.templates.L2PcTemplate;
import com.l24team.gameserver.templates.L2Weapon;
import com.l24team.gameserver.templates.L2WeaponType;
import com.l24team.gameserver.thread.LoginServerThread;
import com.l24team.gameserver.thread.ThreadPoolManager;
import com.l24team.gameserver.thread.daemons.ItemsAutoDestroy;
import com.l24team.gameserver.util.Broadcast;
import com.l24team.gameserver.util.FloodProtectors;
...
public final class L2PcInstance extends L2PlayableInstance
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.l24team.gameserver.model.L2Character.AIAccessor#doAttack(com.l24team.gameserver.model.L2Character)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.l24team.gameserver.model.L2Character.AIAccessor#doCast(com.l24team.gameserver.model.L2Skill)
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.actor.instance.L2PlayableInstance#getKnownList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.actor.instance.L2PlayableInstance#getStat()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.actor.instance.L2PlayableInstance#getStatus()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#updatePvPFlag(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#revalidateZone(boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Object#onActionShift(com.l24team.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.actor.instance.L2PlayableInstance#isInFunEvent()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#getLevelMod()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#toString()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#doRevive()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#doRevive(double)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#onTeleported()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#updatePosition(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#addExpAndSp(long, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#reduceCurrentHp(double, com.l24team.gameserver.model.L2Character)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#reduceCurrentHp(double, com.l24team.gameserver.model.L2Character, boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Character#sendDamageMessage(com.l24team.gameserver.model.L2Character, int, boolean, boolean, boolean)
	 */
	@Override
