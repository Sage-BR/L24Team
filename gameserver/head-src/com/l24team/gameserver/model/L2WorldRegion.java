...
import com.l24team.gameserver.model.zone.L2ZoneManager;
...
import com.l24team.util.object.L2ObjectSet;
			...
			for (final L2Object o : _visibleObjects)
			{
				if (o instanceof L2Attackable)
				{
					...
					if (mob.getAI() != null)
					{
						...
						mob.getAI().setIntention(com.l24team.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
