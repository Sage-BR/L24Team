...
import static com.l24team.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.l24team.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.l24team.gameserver.ai.L2AttackableAI;
...
import com.l24team.gameserver.geo.pathfinding.Node;
...
import com.l24team.gameserver.model.actor.instance.L2GuardInstance;
import com.l24team.gameserver.model.actor.instance.L2ItemInstance;
import com.l24team.gameserver.model.actor.instance.L2MinionInstance;
...
import com.l24team.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.l24team.gameserver.model.actor.instance.L2PcInstance;
import com.l24team.gameserver.model.actor.instance.L2PcInstance.SkillDat;
...
import com.l24team.gameserver.model.actor.instance.L2RiftInvaderInstance;
...
import com.l24team.gameserver.model.actor.knownlist.CharKnownList;
import com.l24team.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
import com.l24team.gameserver.model.actor.position.L2CharPosition;
import com.l24team.gameserver.model.actor.position.ObjectPosition;
import com.l24team.gameserver.model.actor.stat.CharStat;
import com.l24team.gameserver.model.actor.status.CharStatus;
...
import com.l24team.gameserver.network.serverpackets.Attack;
import com.l24team.gameserver.network.serverpackets.BeginRotation;
import com.l24team.gameserver.network.serverpackets.ChangeMoveType;
...
import com.l24team.gameserver.network.serverpackets.CharMoveToLocation;
import com.l24team.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import com.l24team.gameserver.network.serverpackets.L2GameServerPacket;
import com.l24team.gameserver.network.serverpackets.MagicEffectIcons;
import com.l24team.gameserver.network.serverpackets.MagicSkillCanceld;
import com.l24team.gameserver.network.serverpackets.MagicSkillLaunched;
...
import com.l24team.gameserver.network.serverpackets.PartySpelled;
import com.l24team.gameserver.network.serverpackets.PetInfo;
import com.l24team.gameserver.network.serverpackets.RelationChanged;
import com.l24team.gameserver.network.serverpackets.Revive;
...
import com.l24team.gameserver.network.serverpackets.TargetUnselected;
import com.l24team.gameserver.network.serverpackets.TeleportToLocation;
import com.l24team.gameserver.network.serverpackets.ValidateLocation;
import com.l24team.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.l24team.gameserver.skills.Calculator;
...
import com.l24team.gameserver.skills.funcs.Func;
import com.l24team.gameserver.skills.holders.ISkillsHolder;
import com.l24team.gameserver.templates.L2CharTemplate;
...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Object#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Object#getKnownList()
	 */
	@Override
	 ...
	 * <BR>
	 * see com.l24team.gameserver.model.L2Character
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.model.L2Object#toString()
	 */
	@Override
