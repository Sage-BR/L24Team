...
public class AwayCmd implements IVoicedCommandHandler
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.handler.IVoicedCommandHandler#useVoicedCommand(String, com.l24team.gameserver.model.L2PcInstance), String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l24team.gameserver.handler.IVoicedCommandHandler#getVoicedCommandList()
	 */
