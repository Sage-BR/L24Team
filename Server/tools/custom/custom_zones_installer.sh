...
echo "  2 - (Not yet) Install ACM Custom Zone (Powered Mobs (lvl80-85), 4Team Adena Drop (1/4*AdenaDrop just on Higher mobs), High EXP/Adena drop)"
echo "  3 - (Not yet) Install Imperial Tomb Custom Zone (Powered Mobs (lvl85-90) with Raids, Raid Tokens Drop, 4Team Adena Drop (2/4*AdenaDrop just on all mobs), High EXP/Adena drop)"
